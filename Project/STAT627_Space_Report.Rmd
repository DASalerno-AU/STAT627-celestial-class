...
The principal components appear to follow a normal distribution, satisfying the assumption for discriminant analysis.
...
# show performance of model
tree.pruned.s <- summary(tree.pruned)
(tree.pruned.err <- tree.pruned.s[[6]][1] / tree.pruned.s[[6]][2])
```
...
table(y_hat, Y.S.Test)
(rf.optimal.err <- mean(y_hat != Y.S.Test))
```
